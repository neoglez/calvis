...
plausibility of our approach by exploiting the calculated human dimensions as 
ground truth to train a small CNN. After
having trained the network with 
our data, we achieve competitive prediction error.
...
2D intersection curves\cite{yansel} along the y-axis. Moreover, we 
can 
